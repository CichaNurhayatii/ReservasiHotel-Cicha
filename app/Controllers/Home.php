...
class Home extends BaseController
{
    ...
    public function fasilitas(){
        $data['ListFasilitas'] = $this->fasilitashotel->findAll();
    ...
    public function invoice($idreservasi){
        $this->reservasi->select('tbl_reservasi.id_reservasi, tbl_reservasi.nama_pemesan, tbl_reservasi.email_pemesan, 
                                ...
                                tbl_kamar.tarif, tbl_reservasi.jumlah_kamar_dipesan,
                                (datediff(tbl_reservasi.tgl_cek_out, tbl_reservasi.tgl_cek_in))as jml_hari, 
                                (datediff(tbl_reservasi.tgl_cek_out, tbl_reservasi.tgl_cek_in)*tbl_reservasi.jumlah_kamar_dipesan* tbl_kamar.tarif)as total_bayar');
