...
class="form-control" placeholder="Nomor Kamar wajib di Isi" autocomplete="off" autofocus required>
</div>
<div class="form-group">
<label class="font-weight-bold"> Tipe Kamar</label>
<select class="form-control" name="txtInputTipeKamar" required>
        <option value="">Tipe Kamar wajib di Isi</option>
...
<input type="text" name="txtTarif" class="form-control" placeholder="Wajib di Isi" autocomplete="off" autofocus required>
</div>
<div class="form-group">
<label class="font-weight-bold"> Foto Kamar</label>
<input type="file" name="txtInputFoto" class="form-control" placeholder="Foto Wajib di Isi">
</div>
<div class="form-group">
