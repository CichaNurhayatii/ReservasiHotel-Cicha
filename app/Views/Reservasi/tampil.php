...
$htmlData .='<a href="/reservasi/out/'.$row['id_reservasi'].'" class="btn btn-danger btn-sm mr-1">Cek Out</a>';
//$htmlData .='<a href="/reservasi/edit/'.$row['id_reservasi'].'" class="btn btn-danger btn-sm mr-1">Edit</a>';
$htmlData .='</td>';
$htmlData .='</tr>';
echo $htmlData;
}
